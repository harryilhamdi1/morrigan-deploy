...
- [ ] **Keyword Frequency Analysis:** Implement lightweight JavaScript logic to count repetitive words in feedback (e.g., "Panas", "Lama", "Kotor").
- [ ] **Word Cloud Visualization:** Visualize top customer complaints/compliments.
- [ ] **Sentiment Association:** Correlate specific keywords with low section scores (e.g., Link word "Kasar" to "Service").
